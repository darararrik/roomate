...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OptionModel&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.isDisabled, isDisabled) || other.isDisabled == isDisabled));
}
...
@override
String toString() {
  return 'OptionModel(id: $id, title: $title, isDisabled: $isDisabled)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OptionModel&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.isDisabled, isDisabled) || other.isDisabled == isDisabled));
}
