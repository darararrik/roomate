...
part of 'preference_tags_catalog_model.dart';
...
/// @nodoc
mixin _$PreferenceTagsCatalogModel {
...
/// Create a copy of PreferenceTagsCatalogModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PreferenceTagsCatalogModelCopyWith<PreferenceTagsCatalogModel> get copyWith => _$PreferenceTagsCatalogModelCopyWithImpl<PreferenceTagsCatalogModel>(this as PreferenceTagsCatalogModel, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PreferenceTagsCatalogModel&&const DeepCollectionEquality().equals(other.communication, communication)&&const DeepCollectionEquality().equals(other.sleep, sleep)&&const DeepCollectionEquality().equals(other.employment, employment)&&const DeepCollectionEquality().equals(other.badHabits, badHabits)&&const DeepCollectionEquality().equals(other.guests, guests)&&const DeepCollectionEquality().equals(other.noiseLevel, noiseLevel)&&const DeepCollectionEquality().equals(other.cleaning, cleaning)&&const DeepCollectionEquality().equals(other.pets, pets)&&const DeepCollectionEquality().equals(other.petsAttitude, petsAttitude));
}
...
@override
String toString() {
  return 'PreferenceTagsCatalogModel(communication: $communication, sleep: $sleep, employment: $employment, badHabits: $badHabits, guests: $guests, noiseLevel: $noiseLevel, cleaning: $cleaning, pets: $pets, petsAttitude: $petsAttitude)';
}
...
/// @nodoc
abstract mixin class $PreferenceTagsCatalogModelCopyWith<$Res>  {
  factory $PreferenceTagsCatalogModelCopyWith(PreferenceTagsCatalogModel value, $Res Function(PreferenceTagsCatalogModel) _then) = _$PreferenceTagsCatalogModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PreferenceTagsCatalogModelCopyWithImpl<$Res>
    implements $PreferenceTagsCatalogModelCopyWith<$Res> {
  _$PreferenceTagsCatalogModelCopyWithImpl(this._self, this._then);

  final PreferenceTagsCatalogModel _self;
  final $Res Function(PreferenceTagsCatalogModel) _then;
...
/// Adds pattern-matching-related methods to [PreferenceTagsCatalogModel].
extension PreferenceTagsCatalogModelPatterns on PreferenceTagsCatalogModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PreferenceTagsCatalogModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PreferenceTagsCatalogModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PreferenceTagsCatalogModel value)  $default,){
final _that = this;
switch (_that) {
case _PreferenceTagsCatalogModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PreferenceTagsCatalogModel value)?  $default,){
final _that = this;
switch (_that) {
case _PreferenceTagsCatalogModel() when $default != null:
return $default(_that);case _:
...
class _PreferenceTagsCatalogModel implements PreferenceTagsCatalogModel {
  const _PreferenceTagsCatalogModel({final  List<OptionModel> communication = const [], final  List<OptionModel> sleep = const [], final  List<OptionModel> employment = const [], final  List<OptionModel> badHabits = const [], final  List<OptionModel> guests = const [], final  List<OptionModel> noiseLevel = const [], final  List<OptionModel> cleaning = const [], final  List<OptionModel> pets = const [], final  List<OptionModel> petsAttitude = const []}): _communication = communication,_sleep = sleep,_employment = employment,_badHabits = badHabits,_guests = guests,_noiseLevel = noiseLevel,_cleaning = cleaning,_pets = pets,_petsAttitude = petsAttitude;
...
/// @nodoc
abstract mixin class _$PreferenceTagsCatalogModelCopyWith<$Res> implements $PreferenceTagsCatalogModelCopyWith<$Res> {
  factory _$PreferenceTagsCatalogModelCopyWith(_PreferenceTagsCatalogModel value, $Res Function(_PreferenceTagsCatalogModel) _then) = __$PreferenceTagsCatalogModelCopyWithImpl;
@override @useResult
$Res call({
 List<OptionModel> communication, List<OptionModel> sleep, List<OptionModel> employment, List<OptionModel> badHabits, List<OptionModel> guests, List<OptionModel> noiseLevel, List<OptionModel> cleaning, List<OptionModel> pets, List<OptionModel> petsAttitude
});
...
/// @nodoc
class __$PreferenceTagsCatalogModelCopyWithImpl<$Res>
    implements _$PreferenceTagsCatalogModelCopyWith<$Res> {
  __$PreferenceTagsCatalogModelCopyWithImpl(this._self, this._then);

  final _PreferenceTagsCatalogModel _self;
  final $Res Function(_PreferenceTagsCatalogModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? communication = null,Object? sleep = null,Object? employment = null,Object? badHabits = null,Object? guests = null,Object? noiseLevel = null,Object? cleaning = null,Object? pets = null,Object? petsAttitude = null,}) {
  return _then(_PreferenceTagsCatalogModel(
