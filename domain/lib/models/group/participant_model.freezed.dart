...
mixin _$ParticipantModel {
 ...
 String get id; String get fullName; String get avatarUrl; bool get isVerified; String get role;
...
@override
String toString() {
  return 'ParticipantModel(id: $id, fullName: $fullName, avatarUrl: $avatarUrl, isVerified: $isVerified, role: $role)';
}
...
@useResult
$Res call({
 String id, String fullName, String avatarUrl, bool isVerified, String role
});
...
/// Create a copy of ParticipantModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? avatarUrl = null,Object? isVerified = null,Object? role = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fullName,  String avatarUrl,  bool isVerified,  String role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ParticipantModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fullName,  String avatarUrl,  bool isVerified,  String role)  $default,) {final _that = this;
switch (_that) {
case _ParticipantModel():
return $default(_that.id,_that.fullName,_that.avatarUrl,_that.isVerified,_that.role);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fullName,  String avatarUrl,  bool isVerified,  String role)?  $default,) {final _that = this;
switch (_that) {
case _ParticipantModel() when $default != null:
return $default(_that.id,_that.fullName,_that.avatarUrl,_that.isVerified,_that.role);case _:
  return null;
...
class _ParticipantModel implements ParticipantModel {
  const _ParticipantModel({this.id = '', this.fullName = '', this.avatarUrl = '', this.isVerified = false, this.role = ''});
...
/// Create a copy of ParticipantModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fullName = null,Object? avatarUrl = null,Object? isVerified = null,Object? role = null,}) {
