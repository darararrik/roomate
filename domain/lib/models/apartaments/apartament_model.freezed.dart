...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,const DeepCollectionEquality().hash(imageUrls),isVerification,price,roomsCount,area,floor,totalFloor,address,name,role,publishDate,totalViewers,layout,renovation,elevatorType,furnitureType,balconyType,stoveType,dealGoal,rentTerm,const DeepCollectionEquality().hash(whoToRent),prepaymentType,rentalPeriod,deposit,const DeepCollectionEquality().hash(amenities)]);

@override
String toString() {
  return 'ApartamentModel(id: $id, title: $title, description: $description, imageUrls: $imageUrls, isVerification: $isVerification, price: $price, roomsCount: $roomsCount, area: $area, floor: $floor, totalFloor: $totalFloor, address: $address, name: $name, role: $role, publishDate: $publishDate, totalViewers: $totalViewers, layout: $layout, renovation: $renovation, elevatorType: $elevatorType, furnitureType: $furnitureType, balconyType: $balconyType, stoveType: $stoveType, dealGoal: $dealGoal, rentTerm: $rentTerm, whoToRent: $whoToRent, prepaymentType: $prepaymentType, rentalPeriod: $rentalPeriod, deposit: $deposit, amenities: $amenities)';
}
...
/// Create a copy of ApartamentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? imageUrls = null,Object? isVerification = null,Object? price = null,Object? roomsCount = null,Object? area = null,Object? floor = null,Object? totalFloor = null,Object? address = null,Object? name = null,Object? role = null,Object? publishDate = null,Object? totalViewers = null,Object? layout = freezed,Object? renovation = freezed,Object? elevatorType = freezed,Object? furnitureType = freezed,Object? balconyType = freezed,Object? stoveType = freezed,Object? dealGoal = freezed,Object? rentTerm = freezed,Object? whoToRent = null,Object? prepaymentType = freezed,Object? rentalPeriod = freezed,Object? deposit = null,Object? amenities = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String description,  List<String> imageUrls,  bool isVerification,  String price,  String roomsCount,  String area,  int floor,  int totalFloor,  String address,  String name,  String role,  String publishDate,  String totalViewers,  ApartmentLayout? layout,  RenovationType? renovation,  ElevatorType? elevatorType,  FurnitureType? furnitureType,  BalconyType? balconyType,  StoveType? stoveType,  DealGoal? dealGoal,  RentalConditions? rentTerm,  List<WhoToRent> whoToRent,  PrepaymentType? prepaymentType,  RentalPeriod? rentalPeriod,  String deposit,  List<ApartmentAmenity> amenities)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApartamentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String description,  List<String> imageUrls,  bool isVerification,  String price,  String roomsCount,  String area,  int floor,  int totalFloor,  String address,  String name,  String role,  String publishDate,  String totalViewers,  ApartmentLayout? layout,  RenovationType? renovation,  ElevatorType? elevatorType,  FurnitureType? furnitureType,  BalconyType? balconyType,  StoveType? stoveType,  DealGoal? dealGoal,  RentalConditions? rentTerm,  List<WhoToRent> whoToRent,  PrepaymentType? prepaymentType,  RentalPeriod? rentalPeriod,  String deposit,  List<ApartmentAmenity> amenities)  $default,) {final _that = this;
switch (_that) {
case _ApartamentModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String description,  List<String> imageUrls,  bool isVerification,  String price,  String roomsCount,  String area,  int floor,  int totalFloor,  String address,  String name,  String role,  String publishDate,  String totalViewers,  ApartmentLayout? layout,  RenovationType? renovation,  ElevatorType? elevatorType,  FurnitureType? furnitureType,  BalconyType? balconyType,  StoveType? stoveType,  DealGoal? dealGoal,  RentalConditions? rentTerm,  List<WhoToRent> whoToRent,  PrepaymentType? prepaymentType,  RentalPeriod? rentalPeriod,  String deposit,  List<ApartmentAmenity> amenities)?  $default,) {final _that = this;
switch (_that) {
case _ApartamentModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.imageUrls,_that.isVerification,_that.price,_that.roomsCount,_that.area,_that.floor,_that.totalFloor,_that.address,_that.name,_that.role,_that.publishDate,_that.totalViewers,_that.layout,_that.renovation,_that.elevatorType,_that.furnitureType,_that.balconyType,_that.stoveType,_that.dealGoal,_that.rentTerm,_that.whoToRent,_that.prepaymentType,_that.rentalPeriod,_that.deposit,_that.amenities);case _:
  return null;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,const DeepCollectionEquality().hash(_imageUrls),isVerification,price,roomsCount,area,floor,totalFloor,address,name,role,publishDate,totalViewers,layout,renovation,elevatorType,furnitureType,balconyType,stoveType,dealGoal,rentTerm,const DeepCollectionEquality().hash(_whoToRent),prepaymentType,rentalPeriod,deposit,const DeepCollectionEquality().hash(_amenities)]);
...
/// Create a copy of ApartamentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? imageUrls = null,Object? isVerification = null,Object? price = null,Object? roomsCount = null,Object? area = null,Object? floor = null,Object? totalFloor = null,Object? address = null,Object? name = null,Object? role = null,Object? publishDate = null,Object? totalViewers = null,Object? layout = freezed,Object? renovation = freezed,Object? elevatorType = freezed,Object? furnitureType = freezed,Object? balconyType = freezed,Object? stoveType = freezed,Object? dealGoal = freezed,Object? rentTerm = freezed,Object? whoToRent = null,Object? prepaymentType = freezed,Object? rentalPeriod = freezed,Object? deposit = null,Object? amenities = null,}) {
