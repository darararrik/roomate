...
import 'package:roomate/domain/models/ad_form_model/create_ad_form_model.dart';
...
class AdFormNotifier extends _$AdFormNotifier {
  ...
  void setCurrencySelection(int id, String optionTitle) => state = state.copyWith(
        currencyId: id,
  ...
  void updateAddress(String val) => state = state.copyWith(address: val);
