...
part 'my_group_application_detail_notifier.g.dart';

@riverpod
class MyGroupApplicationDetail extends _$MyGroupApplicationDetail {
  PreferenceTagsCatalogModel _tags = const PreferenceTagsCatalogModel();

  @override
  Future<IncomingGroupApplicationDetailModel> build(
    String applicationId,
  ) async {
    final application = await ref.watch(
      applicationDetailForGroupProvider(applicationId).future,
    );
