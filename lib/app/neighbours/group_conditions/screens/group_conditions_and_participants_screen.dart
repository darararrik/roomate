...
import 'package:roomate/app/neighbours/group_conditions/notifier/group_conditions_and_participants_notifier.dart';
...
class GroupConditionsAndParticipantsScreen extends ConsumerWidget {
  ...
  final GroupConditionsModel conditions;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncState = ref.watch(
      groupConditionsAndParticipantsProvider(conditions),
    );
    final notifier = ref.read(
      groupConditionsAndParticipantsProvider(conditions).notifier,
    );
