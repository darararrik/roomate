...
import 'package:roomate/app/neighbours/filters/widgets/neighbours_rent_duration_bottom_sheet.dart';
import 'package:roomate/app/neighbours/filters/widgets/neighbours_sort_bottom_sheet.dart';
import 'package:roomate/lib.dart';

class NeighboursFiltersRow extends StatelessWidget
    implements PreferredSizeWidget {
  const NeighboursFiltersRow({
    super.key,
            ...
            children: [
              ...
              FilterCard(
                ...
                onTap: () => showModalBottomSheet(
                  ...
                  builder: (context) =>
                      const NeighboursRentDurationBottomSheet(),
                ),
              ),
