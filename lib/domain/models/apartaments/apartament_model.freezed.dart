...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String description,  List<String> imageUrls,  bool isVerification,  bool withCompany,  String price,  String roomsCount,  String area,  int floor,  int totalFloor,  String address,  String name,  String role,  String publishDate,  String totalViewers,  ApartmentLayout? layout,  RenovationType? renovation,  ElevatorType? elevatorType,  FurnitureType? furnitureType,  BalconyType? balconyType,  StoveType? stoveType,  DealGoal? dealGoal,  RentalConditions? rentTerm,  List<WhoToRent> whoToRent,  PrepaymentType? prepaymentType,  RentalPeriod? rentalPeriod,  String deposit,  List<ApartmentAmenity> amenities)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApartamentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String description,  List<String> imageUrls,  bool isVerification,  bool withCompany,  String price,  String roomsCount,  String area,  int floor,  int totalFloor,  String address,  String name,  String role,  String publishDate,  String totalViewers,  ApartmentLayout? layout,  RenovationType? renovation,  ElevatorType? elevatorType,  FurnitureType? furnitureType,  BalconyType? balconyType,  StoveType? stoveType,  DealGoal? dealGoal,  RentalConditions? rentTerm,  List<WhoToRent> whoToRent,  PrepaymentType? prepaymentType,  RentalPeriod? rentalPeriod,  String deposit,  List<ApartmentAmenity> amenities)  $default,) {final _that = this;
switch (_that) {
case _ApartamentModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String description,  List<String> imageUrls,  bool isVerification,  bool withCompany,  String price,  String roomsCount,  String area,  int floor,  int totalFloor,  String address,  String name,  String role,  String publishDate,  String totalViewers,  ApartmentLayout? layout,  RenovationType? renovation,  ElevatorType? elevatorType,  FurnitureType? furnitureType,  BalconyType? balconyType,  StoveType? stoveType,  DealGoal? dealGoal,  RentalConditions? rentTerm,  List<WhoToRent> whoToRent,  PrepaymentType? prepaymentType,  RentalPeriod? rentalPeriod,  String deposit,  List<ApartmentAmenity> amenities)?  $default,) {final _that = this;
switch (_that) {
case _ApartamentModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.imageUrls,_that.isVerification,_that.withCompany,_that.price,_that.roomsCount,_that.area,_that.floor,_that.totalFloor,_that.address,_that.name,_that.role,_that.publishDate,_that.totalViewers,_that.layout,_that.renovation,_that.elevatorType,_that.furnitureType,_that.balconyType,_that.stoveType,_that.dealGoal,_that.rentTerm,_that.whoToRent,_that.prepaymentType,_that.rentalPeriod,_that.deposit,_that.amenities);case _:
  return null;
...
@override@JsonKey() final  bool withCompany;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,const DeepCollectionEquality().hash(_imageUrls),isVerification,withCompany,price,roomsCount,area,floor,totalFloor,address,name,role,publishDate,totalViewers,layout,renovation,elevatorType,furnitureType,balconyType,stoveType,dealGoal,rentTerm,const DeepCollectionEquality().hash(_whoToRent),prepaymentType,rentalPeriod,deposit,const DeepCollectionEquality().hash(_amenities)]);
