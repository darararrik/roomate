...
final fetchPreferenceTagsCatalogUseCaseProvider = Provider<FetchPreferenceTagsCatalogUseCase>(
  (ref) => FetchPreferenceTagsCatalogUseCase(ref.read(profileRepositoryProvider)),
);
