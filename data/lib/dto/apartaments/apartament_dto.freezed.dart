...
/// @nodoc
class _$ApartamentDtoCopyWithImpl<$Res>
    implements $ApartamentDtoCopyWith<$Res> {
  _$ApartamentDtoCopyWithImpl(this._self, this._then);

  final ApartamentDto _self;
  final $Res Function(ApartamentDto) _then;

/// Create a copy of ApartamentDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = freezed,Object? description = freezed,Object? imageUrls = freezed,Object? isVerification = freezed,Object? price = freezed,Object? roomsCount = freezed,Object? area = freezed,Object? floor = freezed,Object? totalFloor = freezed,Object? address = freezed,Object? cityId = freezed,Object? name = freezed,Object? role = freezed,Object? publishDate = freezed,Object? totalViewers = freezed,Object? layout = freezed,Object? renovation = freezed,Object? elevatorType = freezed,Object? furnitureType = freezed,Object? balconyType = freezed,Object? stoveType = freezed,Object? dealGoal = freezed,Object? rentTerm = freezed,Object? whoToRent = freezed,Object? prepaymentType = freezed,Object? rentalPeriod = freezed,Object? deposit = freezed,Object? amenities = freezed,}) {
...
/// Adds pattern-matching-related methods to [ApartamentDto].
extension ApartamentDtoPatterns on ApartamentDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ApartamentDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ApartamentDto value)  $default,){
final _that = this;
switch (_that) {
case _ApartamentDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ApartamentDto value)?  $default,){
final _that = this;
switch (_that) {
case _ApartamentDto() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$ApartamentDtoCopyWith<_ApartamentDto> get copyWith => __$ApartamentDtoCopyWithImpl<_ApartamentDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ApartamentDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApartamentDto&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other._imageUrls, _imageUrls)&&(identical(other.isVerification, isVerification) || other.isVerification == isVerification)&&(identical(other.price, price) || other.price == price)&&(identical(other.roomsCount, roomsCount) || other.roomsCount == roomsCount)&&(identical(other.area, area) || other.area == area)&&(identical(other.floor, floor) || other.floor == floor)&&(identical(other.totalFloor, totalFloor) || other.totalFloor == totalFloor)&&(identical(other.address, address) || other.address == address)&&(identical(other.cityId, cityId) || other.cityId == cityId)&&(identical(other.name, name) || other.name == name)&&(identical(other.role, role) || other.role == role)&&(identical(other.publishDate, publishDate) || other.publishDate == publishDate)&&(identical(other.totalViewers, totalViewers) || other.totalViewers == totalViewers)&&(identical(other.layout, layout) || other.layout == layout)&&(identical(other.renovation, renovation) || other.renovation == renovation)&&(identical(other.elevatorType, elevatorType) || other.elevatorType == elevatorType)&&(identical(other.furnitureType, furnitureType) || other.furnitureType == furnitureType)&&(identical(other.balconyType, balconyType) || other.balconyType == balconyType)&&(identical(other.stoveType, stoveType) || other.stoveType == stoveType)&&(identical(other.dealGoal, dealGoal) || other.dealGoal == dealGoal)&&(identical(other.rentTerm, rentTerm) || other.rentTerm == rentTerm)&&const DeepCollectionEquality().equals(other._whoToRent, _whoToRent)&&(identical(other.prepaymentType, prepaymentType) || other.prepaymentType == prepaymentType)&&(identical(other.rentalPeriod, rentalPeriod) || other.rentalPeriod == rentalPeriod)&&(identical(other.deposit, deposit) || other.deposit == deposit)&&const DeepCollectionEquality().equals(other._amenities, _amenities));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,const DeepCollectionEquality().hash(_imageUrls),isVerification,price,roomsCount,area,floor,totalFloor,address,cityId,name,role,publishDate,totalViewers,layout,renovation,elevatorType,furnitureType,balconyType,stoveType,dealGoal,rentTerm,const DeepCollectionEquality().hash(_whoToRent),prepaymentType,rentalPeriod,deposit,const DeepCollectionEquality().hash(_amenities)]);
...
/// @nodoc
abstract mixin class _$ApartamentDtoCopyWith<$Res> implements $ApartamentDtoCopyWith<$Res> {
...
/// @nodoc
class __$ApartamentDtoCopyWithImpl<$Res>
    implements _$ApartamentDtoCopyWith<$Res> {
  __$ApartamentDtoCopyWithImpl(this._self, this._then);

  final _ApartamentDto _self;
  final $Res Function(_ApartamentDto) _then;
