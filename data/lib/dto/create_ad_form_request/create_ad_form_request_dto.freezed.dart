...
class _CreateAdFormRequestDto implements CreateAdFormRequestDto {
  const _CreateAdFormRequestDto({this.rentGoalId = 0, this.rentPeriodId = 0, final  Set<int> whoCanRentIds = const {}, this.premisesTypeId = 0, this.propertyTypeId = 0, this.roomsCountId = 0, this.layoutId = 0, this.renovationId = 0, this.elevatorsId = 0, this.balconiesId = 0, this.furnitureId = 0, final  Set<int> amenitiesIds = const {}, final  Set<int> bathroomIds = const {}, final  Set<int> appliancesIds = const {}, this.stoveId = 0, this.currencyId = 0, this.prepaymentId = 0, this.rentDurationId = 0, final  Set<int> rentConditionsIds = const {}, this.contactMethodId = 0, this.selectedCurrency = Currency.rub, this.cost = 0, this.deposit = 0, this.apartmentArea = 0, this.floor = 0, this.totalFloors = 0, this.address = "", this.apartmentNumber = 0, this.title = "", this.description = "", this.mainPhone = "", this.additionalNumber = ""}): _whoCanRentIds = whoCanRentIds,_amenitiesIds = amenitiesIds,_bathroomIds = bathroomIds,_appliancesIds = appliancesIds,_rentConditionsIds = rentConditionsIds;
