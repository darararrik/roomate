...
@override
String toString() {
  return 'ApartamentData(id: $id, title: $title, description: $description, imageUrls: $imageUrls, isVerification: $isVerification, price: $price, roomsCount: $roomsCount, area: $area, floor: $floor, totalFloor: $totalFloor, address: $address, cityId: $cityId, name: $name, role: $role, publishDate: $publishDate, totalViewers: $totalViewers, layout: $layout, renovation: $renovation, elevatorType: $elevatorType, furnitureType: $furnitureType, balconyType: $balconyType, stoveType: $stoveType, dealGoal: $dealGoal, rentTerm: $rentTerm, whoToRent: $whoToRent, prepaymentType: $prepaymentType, rentalPeriod: $rentalPeriod, deposit: $deposit, amenities: $amenities)';
}
